...
- **RabbitMQ** - чтение из очередей и публикация в очереди RabbitMQ с поддержкой exchanges и routing keys
- **Iceberg** - работа с Apache Iceberg через REST API для работы с большими данными
...
```bash
# Запуск зависимостей (Kafka, PostgreSQL, RabbitMQ, Iceberg)
docker-compose up -d
...
- Поддержка exchanges и routing keys
- Прямая публикация в очереди
- Надежная доставка сообщений

### Iceberg

- Работа через REST API
- Автоматическое создание namespace и таблиц
- Поддержка токенов аутентификации
- Оптимизировано для работы с большими данными
