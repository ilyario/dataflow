...
// String returns the ContentKey as a dot-separated string for URL encoding
// This is required by Nessie API v2 specification where content key components
// are separated by the dot (`.`) character.
func (o *ContentKey) String() string {
