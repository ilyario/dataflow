...
type Put struct {
	...
	// Deprecated
	ExpectedContent *Content `json:"expectedContent,omitempty"`
...
// SetExpectedContent gets a reference to the given Content and assigns it to the ExpectedContent field.
// Deprecated
...
// SetDocumentation gets a reference to the given Documentation and assigns it to the Documentation field.
