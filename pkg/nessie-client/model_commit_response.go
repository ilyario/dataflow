...
type CommitResponse struct {
	...
	AddedContents []AddedContent `json:"addedContents,omitempty"`
}
...
// SetAddedContents gets a reference to the given []AddedContent and assigns it to the AddedContents field.
