...
type UpdateRepositoryConfigResponse struct {
	Previous *GarbageCollectorConfig `json:"previous,omitempty"`
}
...
func (o *UpdateRepositoryConfigResponse) GetPrevious() GarbageCollectorConfig {
	if o == nil || IsNil(o.Previous) {
		var ret GarbageCollectorConfig
		return ret
	}
	return *o.Previous
}
...
// SetPrevious gets a reference to the given GarbageCollectorConfig and assigns it to the Previous field.
