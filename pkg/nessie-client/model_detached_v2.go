...
type DetachedV2 struct {
	...
	Metadata *ReferenceMetadataV2 `json:"metadata,omitempty"`
}
...
// SetMetadata gets a reference to the given ReferenceMetadataV2 and assigns it to the Metadata field.
