...
type ReferenceHistoryResponseV2 struct {
	...
	// Consistency status of the current HEAD commit.
	Current ReferenceHistoryStateV2 `json:"current"`
	// Consistency status of the recorded recent HEADs of the reference, including re-assign operations.
	Previous []ReferenceHistoryStateV2 `json:"previous"`
	// Combined consistency status of the commit-log of the reference, if requested by the client.
	CommitLogConsistency CommitConsistencyV2 `json:"commitLogConsistency"`
}
...
func (o *ReferenceHistoryResponseV2) GetCurrent() ReferenceHistoryStateV2 {
	if o == nil {
		var ret ReferenceHistoryStateV2
		return ret
	}
