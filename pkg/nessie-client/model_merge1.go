...
type Merge1 struct {
	...
	KeyMergeModes []MergeKeyBehavior `json:"keyMergeModes,omitempty"`
	...
	DefaultKeyMergeMode *MergeBehavior `json:"defaultKeyMergeMode,omitempty"`
	...
	CommitMeta *CommitMeta `json:"commitMeta,omitempty"`
}
...
// SetKeyMergeModes gets a reference to the given []MergeKeyBehavior and assigns it to the KeyMergeModes field.
...
// SetDefaultKeyMergeMode gets a reference to the given MergeBehavior and assigns it to the DefaultKeyMergeMode field.
...
// SetCommitMeta gets a reference to the given CommitMeta and assigns it to the CommitMeta field.
