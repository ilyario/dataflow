...
type ContentKeyDetailsV1 struct {
	...
	MergeBehavior *MergeBehaviorV1 `json:"mergeBehavior,omitempty"`
}
...
// SetMergeBehavior gets a reference to the given MergeBehaviorV1 and assigns it to the MergeBehavior field.
