...
type CommitResponseV2 struct {
	TargetBranch BranchV2 `json:"targetBranch"`
	AddedContents []AddedContentV2 `json:"addedContents,omitempty"`
}
...
// SetAddedContents gets a reference to the given []AddedContentV2 and assigns it to the AddedContents field.
