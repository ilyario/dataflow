...
type GetMultipleContentsResponse struct {
	Contents []ContentWithKey `json:"contents"`
	EffectiveReference *Reference `json:"effectiveReference,omitempty"`
}
...
// SetEffectiveReference gets a reference to the given Reference and assigns it to the EffectiveReference field.
