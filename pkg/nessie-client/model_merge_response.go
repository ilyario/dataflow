...
type MergeResponse struct {
	...
	Details []ContentKeyDetails `json:"details,omitempty"`
}
...
// SetDetails gets a reference to the given []ContentKeyDetails and assigns it to the Details field.
