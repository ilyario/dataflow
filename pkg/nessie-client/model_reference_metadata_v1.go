...
type ReferenceMetadataV1 struct {
	...
	CommitMetaOfHEAD *CommitMetaV1 `json:"commitMetaOfHEAD,omitempty"`
...
// SetCommitMetaOfHEAD gets a reference to the given CommitMetaV1 and assigns it to the CommitMetaOfHEAD field.
