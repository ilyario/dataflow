...
type ReferenceMetadata struct {
	...
	CommitMetaOfHEAD *CommitMeta `json:"commitMetaOfHEAD,omitempty"`
...
// SetCommitMetaOfHEAD gets a reference to the given CommitMeta and assigns it to the CommitMetaOfHEAD field.
