...
type ReferenceHistoryStateV2 struct {
	...
	CommitConsistency *CommitConsistencyV2 `json:"commitConsistency,omitempty"`
	// Meta information from the commit, if available.
	Meta *CommitMetaV2 `json:"meta,omitempty"`
}
...
// SetCommitConsistency gets a reference to the given CommitConsistencyV2 and assigns it to the CommitConsistency field.
...
// SetMeta gets a reference to the given CommitMetaV2 and assigns it to the Meta field.
