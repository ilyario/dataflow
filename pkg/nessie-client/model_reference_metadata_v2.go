...
type ReferenceMetadataV2 struct {
	...
	CommitMetaOfHEAD *CommitMetaV2 `json:"commitMetaOfHEAD,omitempty"`
...
// SetCommitMetaOfHEAD gets a reference to the given CommitMetaV2 and assigns it to the CommitMetaOfHEAD field.
