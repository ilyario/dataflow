...
func (o *CommitMeta) UnmarshalJSON(data []byte) (err error) {
	...
	varCommitMeta := _CommitMeta{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCommitMeta)

	if err != nil {
		return err
	}

	*o = CommitMeta(varCommitMeta)
