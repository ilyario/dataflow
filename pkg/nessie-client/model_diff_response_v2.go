...
type DiffResponseV2 struct {
	...
	Diffs []DiffEntryV2 `json:"diffs,omitempty"`
	EffectiveFromReference *ReferenceV2 `json:"effectiveFromReference,omitempty"`
	EffectiveToReference *ReferenceV2 `json:"effectiveToReference,omitempty"`
}
...
// SetDiffs gets a reference to the given []DiffEntryV2 and assigns it to the Diffs field.
...
// SetEffectiveFromReference gets a reference to the given ReferenceV2 and assigns it to the EffectiveFromReference field.
...
// SetEffectiveToReference gets a reference to the given ReferenceV2 and assigns it to the EffectiveToReference field.
