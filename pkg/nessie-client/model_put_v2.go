...
type PutV2 struct {
	...
	Metadata []ContentMetadataV2 `json:"metadata,omitempty"`
...
// SetMetadata gets a reference to the given []ContentMetadataV2 and assigns it to the Metadata field.
