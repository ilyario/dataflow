...
`func NewUnchanged(key ContentKey, ) *Unchanged`
...
`func (o *Unchanged) GetKey() ContentKey`

GetKey returns the Key field if non-nil, zero value otherwise.

### GetKeyOk

`func (o *Unchanged) GetKeyOk() (*ContentKey, bool)`
...
`func (o *Unchanged) SetKey(v ContentKey)`
