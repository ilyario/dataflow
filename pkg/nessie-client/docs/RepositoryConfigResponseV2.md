...
------------ | ------------- | ------------- | -------------
**Configs** | Pointer to [**[]GarbageCollectorConfigV2**](GarbageCollectorConfigV2.md) | The existing configuration objects for the requested types will be returned. Non-existing config objects will not be returned. | [optional] 
...
`func (o *RepositoryConfigResponseV2) GetConfigs() []GarbageCollectorConfigV2`

GetConfigs returns the Configs field if non-nil, zero value otherwise.

### GetConfigsOk

`func (o *RepositoryConfigResponseV2) GetConfigsOk() (*[]GarbageCollectorConfigV2, bool)`
...
`func (o *RepositoryConfigResponseV2) SetConfigs(v []GarbageCollectorConfigV2)`
