...
------------ | ------------- | ------------- | -------------
**RequestedKeys** | [**[]ContentKey**](ContentKey.md) |  | 

## Methods

### NewGetMultipleContentsRequest

`func NewGetMultipleContentsRequest(requestedKeys []ContentKey, ) *GetMultipleContentsRequest`
...
`func (o *GetMultipleContentsRequest) GetRequestedKeys() []ContentKey`

GetRequestedKeys returns the RequestedKeys field if non-nil, zero value otherwise.

### GetRequestedKeysOk

`func (o *GetMultipleContentsRequest) GetRequestedKeysOk() (*[]ContentKey, bool)`
...
`func (o *GetMultipleContentsRequest) SetRequestedKeys(v []ContentKey)`
