...
func (r ApiAssignReferenceV2Request) Reference(reference Reference) ApiAssignReferenceV2Request {
...
func (r ApiAssignReferenceV2Request) Execute() (*SingleReferenceResponseV2, *http.Response, error) {
...
//  @return SingleReferenceResponseV2
func (a *V2APIService) AssignReferenceV2Execute(r ApiAssignReferenceV2Request) (*SingleReferenceResponseV2, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPut
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *SingleReferenceResponseV2
	)
...
func (r ApiCommitV2Request) Operations(operations Operations) ApiCommitV2Request {
	r.operations = &operations
	return r
}

func (r ApiCommitV2Request) Execute() (*CommitResponseV2, *http.Response, error) {
...
// Execute executes the request
//  @return CommitResponseV2
func (a *V2APIService) CommitV2Execute(r ApiCommitV2Request) (*CommitResponseV2, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *CommitResponseV2
	)
...
func (r ApiCreateReferenceV2Request) Reference(reference Reference) ApiCreateReferenceV2Request {
	r.reference = &reference
	return r
}

func (r ApiCreateReferenceV2Request) Execute() (*SingleReferenceResponseV2, *http.Response, error) {
...
// Execute executes the request
//  @return SingleReferenceResponseV2
func (a *V2APIService) CreateReferenceV2Execute(r ApiCreateReferenceV2Request) (*SingleReferenceResponseV2, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r ApiDeleteReferenceV2Request) Execute() (*SingleReferenceResponseV2, *http.Response, error) {
...
// Execute executes the request
//  @return SingleReferenceResponseV2
func (a *V2APIService) DeleteReferenceV2Execute(r ApiDeleteReferenceV2Request) (*SingleReferenceResponseV2, *http.Response, error) {
	var (
...
func (r ApiGetAllReferencesV2Request) Fetch(fetch FetchOption) ApiGetAllReferencesV2Request {
	r.fetch = &fetch
	return r
}
...
func (r ApiGetAllReferencesV2Request) Execute() (*ReferencesResponseV2, *http.Response, error) {
...
// Execute executes the request
//  @return ReferencesResponseV2
func (a *V2APIService) GetAllReferencesV2Execute(r ApiGetAllReferencesV2Request) (*ReferencesResponseV2, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *ReferencesResponseV2
	)
...
func (r ApiGetCommitLogV2Request) Fetch(fetch FetchOption) ApiGetCommitLogV2Request {
	r.fetch = &fetch
	return r
}
...
func (r ApiGetCommitLogV2Request) Execute() (*LogResponseV2, *http.Response, error) {
...
// Execute executes the request
//  @return LogResponseV2
func (a *V2APIService) GetCommitLogV2Execute(r ApiGetCommitLogV2Request) (*LogResponseV2, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *LogResponseV2
	)
...
func (r ApiGetConfigV2Request) Execute() (*NessieConfigurationV2, *http.Response, error) {
...
// Execute executes the request
//  @return NessieConfigurationV2
func (a *V2APIService) GetConfigV2Execute(r ApiGetConfigV2Request) (*NessieConfigurationV2, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *NessieConfigurationV2
	)
...
func (r ApiGetContentV2Request) Execute() (*ContentResponseV2, *http.Response, error) {
...
*/
func (a *V2APIService) GetContentV2(ctx context.Context, key ContentKey, ref interface{}) ApiGetContentV2Request {
	return ApiGetContentV2Request{
		ApiService: a,
		ctx: ctx,
		key: key,
...
// Execute executes the request
//  @return ContentResponseV2
func (a *V2APIService) GetContentV2Execute(r ApiGetContentV2Request) (*ContentResponseV2, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *ContentResponseV2
	)
...
func (r ApiGetDiffV2Request) Key(key []ContentKey) ApiGetDiffV2Request {
	r.key = &key
	return r
}
...
func (r ApiGetDiffV2Request) MaxKey(maxKey ContentKey) ApiGetDiffV2Request {
	r.maxKey = &maxKey
	return r
}
...
func (r ApiGetDiffV2Request) MinKey(minKey ContentKey) ApiGetDiffV2Request {
	r.minKey = &minKey
	return r
}
...
func (r ApiGetDiffV2Request) PrefixKey(prefixKey ContentKey) ApiGetDiffV2Request {
	r.prefixKey = &prefixKey
	return r
}

func (r ApiGetDiffV2Request) Execute() (*DiffResponseV2, *http.Response, error) {
...
// Execute executes the request
//  @return DiffResponseV2
func (a *V2APIService) GetDiffV2Execute(r ApiGetDiffV2Request) (*DiffResponseV2, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *DiffResponseV2
	)
...
// Restrict the result to one or more keys.  Can be combined with min/max-key and prefix-key parameters, however both predicates must match. This means that keys specified via this parameter that do not match a given min/max-key or prefix-key will not be returned.  Content key and namespace components are separated by the dot (&#x60;.&#x60;) character. The components itself must be escaped using the rules described in [NESSIE-SPEC-2.0.md in the repository](https://github.com/projectnessie/nessie/blob/main/api/NESSIE-SPEC-2-0.md).
func (r ApiGetEntriesV2Request) Key(key []ContentKey) ApiGetEntriesV2Request {
	r.key = &key
	return r
}

// The upper bound of the content key range to retrieve (inclusive). The content keys of all returned entries will be less than or equal to the max-value. Content-keys are compared as a &#39;whole&#39;, unlike prefix-keys.  Content key and namespace components are separated by the dot (&#x60;.&#x60;) character. The components itself must be escaped using the rules described in [NESSIE-SPEC-2.0.md in the repository](https://github.com/projectnessie/nessie/blob/main/api/NESSIE-SPEC-2-0.md).
func (r ApiGetEntriesV2Request) MaxKey(maxKey ContentKey) ApiGetEntriesV2Request {
	r.maxKey = &maxKey
	return r
}
...
// The lower bound of the content key range to retrieve (inclusive). The content keys of all returned entries will be greater than or equal to the min-value. Content-keys are compared as a &#39;whole&#39;, unlike prefix-keys.  Content key and namespace components are separated by the dot (&#x60;.&#x60;) character. The components itself must be escaped using the rules described in [NESSIE-SPEC-2.0.md in the repository](https://github.com/projectnessie/nessie/blob/main/api/NESSIE-SPEC-2-0.md).
func (r ApiGetEntriesV2Request) MinKey(minKey ContentKey) ApiGetEntriesV2Request {
	r.minKey = &minKey
	return r
}
...
// The content key prefix to retrieve (inclusive). A content key matches a given prefix, a content key&#39;s elements starts with all elements of the prefix-key. Key prefixes exactly match key-element boundaries.  Must not be combined with min/max-key parameters.  Content key and namespace components are separated by the dot (&#x60;.&#x60;) character. The components itself must be escaped using the rules described in [NESSIE-SPEC-2.0.md in the repository](https://github.com/projectnessie/nessie/blob/main/api/NESSIE-SPEC-2-0.md).
func (r ApiGetEntriesV2Request) PrefixKey(prefixKey ContentKey) ApiGetEntriesV2Request {
	r.prefixKey = &prefixKey
	return r
}

func (r ApiGetEntriesV2Request) Execute() (*EntriesResponseV2, *http.Response, error) {
...
// Execute executes the request
//  @return EntriesResponseV2
func (a *V2APIService) GetEntriesV2Execute(r ApiGetEntriesV2Request) (*EntriesResponseV2, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *EntriesResponseV2
	)
...
// Keys to retrieve.
func (r ApiGetMultipleContentsV2Request) GetMultipleContentsRequest(getMultipleContentsRequest GetMultipleContentsRequest) ApiGetMultipleContentsV2Request {
...
func (r ApiGetMultipleContentsV2Request) Execute() (*GetMultipleContentsResponseV2, *http.Response, error) {
...
// Execute executes the request
//  @return GetMultipleContentsResponseV2
func (a *V2APIService) GetMultipleContentsV2Execute(r ApiGetMultipleContentsV2Request) (*GetMultipleContentsResponseV2, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *GetMultipleContentsResponseV2
	)
...
func (r ApiGetReferenceByNameV2Request) Fetch(fetch FetchOption) ApiGetReferenceByNameV2Request {
	r.fetch = &fetch
	return r
}

func (r ApiGetReferenceByNameV2Request) Execute() (*SingleReferenceResponseV2, *http.Response, error) {
...
// Execute executes the request
//  @return SingleReferenceResponseV2
func (a *V2APIService) GetReferenceByNameV2Execute(r ApiGetReferenceByNameV2Request) (*SingleReferenceResponseV2, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r ApiGetReferenceHistoryRequest) Execute() (*ReferenceHistoryResponseV2, *http.Response, error) {
...
// Execute executes the request
//  @return ReferenceHistoryResponseV2
func (a *V2APIService) GetReferenceHistoryExecute(r ApiGetReferenceHistoryRequest) (*ReferenceHistoryResponseV2, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *ReferenceHistoryResponseV2
	)
...
func (r ApiGetSeveralContentsRequest) Execute() (*GetMultipleContentsResponseV2, *http.Response, error) {
...
// Execute executes the request
//  @return GetMultipleContentsResponseV2
func (a *V2APIService) GetSeveralContentsExecute(r ApiGetSeveralContentsRequest) (*GetMultipleContentsResponseV2, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r ApiMergeV2Request) Merge1(merge1 Merge1) ApiMergeV2Request {
	r.merge1 = &merge1
	return r
}

func (r ApiMergeV2Request) Execute() (*MergeResponseV2, *http.Response, error) {
...
// Execute executes the request
//  @return MergeResponseV2
func (a *V2APIService) MergeV2Execute(r ApiMergeV2Request) (*MergeResponseV2, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *MergeResponseV2
	)
	...
	localVarFormParams := url.Values{}
	if r.merge1 == nil {
		return localVarReturnValue, nil, reportError("merge1 is required and must be specified")
	}
...
func (r ApiTransplantV2Request) Transplant1(transplant1 Transplant1) ApiTransplantV2Request {
	r.transplant1 = &transplant1
	return r
}

func (r ApiTransplantV2Request) Execute() (*MergeResponseV2, *http.Response, error) {
...
// Execute executes the request
//  @return MergeResponseV2
func (a *V2APIService) TransplantV2Execute(r ApiTransplantV2Request) (*MergeResponseV2, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
