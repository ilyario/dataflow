...
func (r ApiAssignReferenceRequest) Reference(reference Reference) ApiAssignReferenceRequest {
...
*/
func (a *V1APIService) AssignReference(ctx context.Context, referenceName string, referenceType ReferenceType) ApiAssignReferenceRequest {
	return ApiAssignReferenceRequest{
		ApiService: a,
		ctx: ctx,
...
func (a *V1APIService) AssignReferenceExecute(r ApiAssignReferenceRequest) (*http.Response, error) {
	...
	if r.reference == nil {
		return nil, reportError("reference is required and must be specified")
	}
...
// Operations
func (r ApiCommitMultipleOperationsRequest) Operations(operations Operations) ApiCommitMultipleOperationsRequest {
...
func (r ApiCommitMultipleOperationsRequest) Execute() (*BranchV1, *http.Response, error) {
...
// Execute executes the request
//  @return BranchV1
func (a *V1APIService) CommitMultipleOperationsExecute(r ApiCommitMultipleOperationsRequest) (*BranchV1, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *BranchV1
	)
	...
	localVarFormParams := url.Values{}
	if r.operations == nil {
		return localVarReturnValue, nil, reportError("operations is required and must be specified")
	}
...
func (r ApiCreateNamespaceRequest) Execute() (*NamespaceV1, *http.Response, error) {
...
*/
func (a *V1APIService) CreateNamespace(ctx context.Context, name Namespace, ref string) ApiCreateNamespaceRequest {
	return ApiCreateNamespaceRequest{
		ApiService: a,
		ctx: ctx,
		name: name,
...
// Execute executes the request
//  @return NamespaceV1
func (a *V1APIService) CreateNamespaceExecute(r ApiCreateNamespaceRequest) (*NamespaceV1, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPut
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *NamespaceV1
	)
...
// Reference to create.
func (r ApiCreateReferenceRequest) Reference(reference Reference) ApiCreateReferenceRequest {
	r.reference = &reference
	return r
}
...
func (r ApiCreateReferenceRequest) Execute() (*ReferenceV1, *http.Response, error) {
...
// Execute executes the request
//  @return ReferenceV1
func (a *V1APIService) CreateReferenceExecute(r ApiCreateReferenceRequest) (*ReferenceV1, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *ReferenceV1
	)
...
*/
func (a *V1APIService) DeleteNamespace(ctx context.Context, name Namespace, ref string) ApiDeleteNamespaceRequest {
	return ApiDeleteNamespaceRequest{
		ApiService: a,
		ctx: ctx,
		name: name,
...
*/
func (a *V1APIService) DeleteReference(ctx context.Context, referenceName string, referenceType ReferenceType) ApiDeleteReferenceRequest {
	return ApiDeleteReferenceRequest{
		ApiService: a,
		ctx: ctx,
		referenceName: referenceName,
...
func (r ApiGetAllReferencesRequest) Fetch(fetch FetchOption) ApiGetAllReferencesRequest {
	r.fetch = &fetch
	return r
}
...
func (r ApiGetAllReferencesRequest) Execute() (*ReferencesResponseV1, *http.Response, error) {
...
// Execute executes the request
//  @return ReferencesResponseV1
func (a *V1APIService) GetAllReferencesExecute(r ApiGetAllReferencesRequest) (*ReferencesResponseV1, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *ReferencesResponseV1
	)
...
func (r ApiGetCommitLogRequest) Fetch(fetch FetchOption) ApiGetCommitLogRequest {
	r.fetch = &fetch
	return r
}
...
func (r ApiGetCommitLogRequest) Execute() (*LogResponseV1, *http.Response, error) {
...
// Execute executes the request
//  @return LogResponseV1
func (a *V1APIService) GetCommitLogExecute(r ApiGetCommitLogRequest) (*LogResponseV1, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *LogResponseV1
	)
...
func (r ApiGetConfigRequest) Execute() (*NessieConfigurationV1, *http.Response, error) {
...
// Execute executes the request
//  @return NessieConfigurationV1
func (a *V1APIService) GetConfigExecute(r ApiGetConfigRequest) (*NessieConfigurationV1, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *NessieConfigurationV1
	)
...
func (r ApiGetContentRequest) Execute() (*ContentV1, *http.Response, error) {
...
// Execute executes the request
//  @return ContentV1
func (a *V1APIService) GetContentExecute(r ApiGetContentRequest) (*ContentV1, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *ContentV1
	)
...
func (r ApiGetDefaultBranchRequest) Execute() (*BranchV1, *http.Response, error) {
...
// Execute executes the request
//  @return BranchV1
func (a *V1APIService) GetDefaultBranchExecute(r ApiGetDefaultBranchRequest) (*BranchV1, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r ApiGetDiffRequest) Execute() (*DiffResponseV1, *http.Response, error) {
...
// Execute executes the request
//  @return DiffResponseV1
func (a *V1APIService) GetDiffExecute(r ApiGetDiffRequest) (*DiffResponseV1, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *DiffResponseV1
	)
...
func (r ApiGetEntriesRequest) Execute() (*EntriesResponseV1, *http.Response, error) {
...
// Execute executes the request
//  @return EntriesResponseV1
func (a *V1APIService) GetEntriesExecute(r ApiGetEntriesRequest) (*EntriesResponseV1, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *EntriesResponseV1
	)
...
// Keys to retrieve.
func (r ApiGetMultipleContentsRequest) GetMultipleContentsRequest(getMultipleContentsRequest GetMultipleContentsRequest) ApiGetMultipleContentsRequest {
	r.getMultipleContentsRequest = &getMultipleContentsRequest
	return r
}
...
func (r ApiGetMultipleContentsRequest) Execute() (*GetMultipleContentsResponseV1, *http.Response, error) {
...
// Execute executes the request
//  @return GetMultipleContentsResponseV1
func (a *V1APIService) GetMultipleContentsExecute(r ApiGetMultipleContentsRequest) (*GetMultipleContentsResponseV1, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *GetMultipleContentsResponseV1
	)
	...
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.getMultipleContentsRequest == nil {
		return localVarReturnValue, nil, reportError("getMultipleContentsRequest is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.getMultipleContentsRequest
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
...
func (r ApiGetNamespaceRequest) Execute() (*NamespaceV1, *http.Response, error) {
...
*/
func (a *V1APIService) GetNamespace(ctx context.Context, name Namespace, ref string) ApiGetNamespaceRequest {
	return ApiGetNamespaceRequest{
		ApiService: a,
		ctx: ctx,
		name: name,
...
// Execute executes the request
//  @return NamespaceV1
func (a *V1APIService) GetNamespaceExecute(r ApiGetNamespaceRequest) (*NamespaceV1, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r ApiGetNamespacesRequest) Name(name Namespace) ApiGetNamespacesRequest {
	r.name = &name
	return r
}

func (r ApiGetNamespacesRequest) Execute() (*GetNamespacesResponseV1, *http.Response, error) {
...
// Execute executes the request
//  @return GetNamespacesResponseV1
func (a *V1APIService) GetNamespacesExecute(r ApiGetNamespacesRequest) (*GetNamespacesResponseV1, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *GetNamespacesResponseV1
	)
...
// Specify how much information to be returned. Will fetch additional metadata for references if set to &#39;ALL&#39;.  A returned Branch instance will have the following information:  - numCommitsAhead (number of commits ahead of the default branch)  - numCommitsBehind (number of commits behind the default branch)  - commitMetaOfHEAD (the commit metadata of the HEAD commit)  - commonAncestorHash (the hash of the common ancestor in relation to the default branch).  - numTotalCommits (the total number of commits in this reference).  A returned Tag instance will only contain the &#39;commitMetaOfHEAD&#39; and &#39;numTotalCommits&#39; fields.  Note that computing &amp; fetching additional metadata might be computationally expensive on the server-side, so this flag should be used with care.
func (r ApiGetReferenceByNameRequest) Fetch(fetch FetchOption) ApiGetReferenceByNameRequest {
	r.fetch = &fetch
	return r
}

func (r ApiGetReferenceByNameRequest) Execute() (*ReferenceV1, *http.Response, error) {
...
// Execute executes the request
//  @return ReferenceV1
func (a *V1APIService) GetReferenceByNameExecute(r ApiGetReferenceByNameRequest) (*ReferenceV1, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r ApiMergeRefIntoBranchRequest) Merge(merge Merge) ApiMergeRefIntoBranchRequest {
	r.merge = &merge
	return r
}

func (r ApiMergeRefIntoBranchRequest) Execute() (*MergeResponseV1, *http.Response, error) {
...
// Execute executes the request
//  @return MergeResponseV1
func (a *V1APIService) MergeRefIntoBranchExecute(r ApiMergeRefIntoBranchRequest) (*MergeResponseV1, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *MergeResponseV1
	)
...
func (r ApiTransplantCommitsIntoBranchRequest) Transplant(transplant Transplant) ApiTransplantCommitsIntoBranchRequest {
...
func (r ApiTransplantCommitsIntoBranchRequest) Execute() (*MergeResponseV1, *http.Response, error) {
...
// Execute executes the request
//  @return MergeResponseV1
func (a *V1APIService) TransplantCommitsIntoBranchExecute(r ApiTransplantCommitsIntoBranchRequest) (*MergeResponseV1, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	if r.transplant == nil {
		return localVarReturnValue, nil, reportError("transplant is required and must be specified")
	}
...
func (r ApiUpdatePropertiesRequest) NamespaceUpdate(namespaceUpdate NamespaceUpdate) ApiUpdatePropertiesRequest {
	r.namespaceUpdate = &namespaceUpdate
	return r
}
...
*/
func (a *V1APIService) UpdateProperties(ctx context.Context, name Namespace, ref string) ApiUpdatePropertiesRequest {
	return ApiUpdatePropertiesRequest{
		ApiService: a,
		ctx: ctx,
		name: name,
...
func (a *V1APIService) UpdatePropertiesExecute(r ApiUpdatePropertiesRequest) (*http.Response, error) {
	...
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.namespaceUpdate == nil {
		return nil, reportError("namespaceUpdate is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.namespaceUpdate
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return nil, err
	}
