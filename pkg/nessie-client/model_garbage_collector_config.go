...
type GarbageCollectorConfig struct {
	...
	PerRefCutoffPolicies []ReferenceCutoffPolicy `json:"perRefCutoffPolicies,omitempty"`
...
// SetPerRefCutoffPolicies gets a reference to the given []ReferenceCutoffPolicy and assigns it to the PerRefCutoffPolicies field.
