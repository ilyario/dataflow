...
type MergeResponseV1 struct {
	...
	Details []ContentKeyDetailsV1 `json:"details,omitempty"`
}
...
// SetDetails gets a reference to the given []ContentKeyDetailsV1 and assigns it to the Details field.
