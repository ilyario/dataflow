...
type DiffEntry struct {
	...
	From *Content `json:"from,omitempty"`
	To *Content `json:"to,omitempty"`
}
...
// SetFrom gets a reference to the given Content and assigns it to the From field.
...
// SetTo gets a reference to the given Content and assigns it to the To field.
