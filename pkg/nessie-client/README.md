...
The package is already integrated into this project. Use the following import:

```go
import openapi "github.com/dataflow-operator/dataflow/pkg/nessie-client"
```

Or if you want to use it in another project, add this to your `go.mod`:

```go
replace github.com/dataflow-operator/dataflow/pkg/nessie-client => ./path/to/nessie-client
```
