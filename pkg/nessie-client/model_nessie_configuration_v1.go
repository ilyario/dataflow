...
// checks if the NessieConfigurationV1 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NessieConfigurationV1{}

// NessieConfigurationV1 Configuration object to tell a client how a server is configured.
type NessieConfigurationV1 struct {
...
func (o NessieConfigurationV1) MarshalJSON() ([]byte, error) {
...
func (o NessieConfigurationV1) ToMap() (map[string]interface{}, error) {
...
type NullableNessieConfigurationV1 struct {
	value *NessieConfigurationV1
	isSet bool
}

func (v NullableNessieConfigurationV1) Get() *NessieConfigurationV1 {
	return v.value
}

func (v *NullableNessieConfigurationV1) Set(val *NessieConfigurationV1) {
	v.value = val
	v.isSet = true
}

func (v NullableNessieConfigurationV1) IsSet() bool {
	return v.isSet
}

func (v *NullableNessieConfigurationV1) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNessieConfigurationV1(val *NessieConfigurationV1) *NullableNessieConfigurationV1 {
	return &NullableNessieConfigurationV1{value: val, isSet: true}
}

func (v NullableNessieConfigurationV1) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNessieConfigurationV1) UnmarshalJSON(src []byte) error {
	v.isSet = true
