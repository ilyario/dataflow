...
type GarbageCollectorConfigV2 struct {
	...
	PerRefCutoffPolicies []ReferenceCutoffPolicyV2 `json:"perRefCutoffPolicies,omitempty"`
...
func (o *GarbageCollectorConfigV2) GetPerRefCutoffPolicies() []ReferenceCutoffPolicyV2 {
	if o == nil || IsNil(o.PerRefCutoffPolicies) {
		var ret []ReferenceCutoffPolicyV2
		return ret
	}
...
// SetPerRefCutoffPolicies gets a reference to the given []ReferenceCutoffPolicyV2 and assigns it to the PerRefCutoffPolicies field.
