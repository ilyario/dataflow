...
type MergeResponseV2 struct {
	...
	Details []ContentKeyDetailsV2 `json:"details,omitempty"`
}
...
// SetDetails gets a reference to the given []ContentKeyDetailsV2 and assigns it to the Details field.
