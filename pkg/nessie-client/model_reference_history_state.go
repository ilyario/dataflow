...
type ReferenceHistoryState struct {
	...
	CommitConsistency *CommitConsistency `json:"commitConsistency,omitempty"`
	// Meta information from the commit, if available.
	Meta *CommitMeta `json:"meta,omitempty"`
}
...
// SetCommitConsistency gets a reference to the given CommitConsistency and assigns it to the CommitConsistency field.
...
// SetMeta gets a reference to the given CommitMeta and assigns it to the Meta field.
